			...
			<div class="services-list block-1-2 block-tab-full group">
				...
				<div class="bgrid service-item animate-this">
					...
					<div class="service-content">
						<h3 class="h05">Java-based frameworks</h3>
						<p></p>
					</div>
				...
				<div class="bgrid service-item animate-this">
					<span class="icon">
						<i class="icon-padlock-open"></i>
					</span>
					<div class="service-content">
						<h3 class="h05">Open-source technologies</h3>
						<p></p>
					</div>
				</div>
				<!-- end bgrid -->
				...
				<div class="bgrid service-item animate-this">
					...
					<div class="service-content">
						<h3 class="h05">Cloud-based development</h3>
						<p></p>
					</div>
				</div>
				<!-- end bgrid -->
				...
				<div class="bgrid service-item animate-this">
					...
					<div class="service-content">
						<h3 class="h05">Networks and systems security</h3>
						<p></p>
					</div>
				</div>
				<!-- end bgrid -->
				...
				<div class="bgrid service-item animate-this">
					...
					<div class="service-content">
						<h3 class="h05">Database and warehouse technology</h3>
						<p></p>
					</div>
				</div>
				<!-- end bgrid -->
				...
				<div class="bgrid service-item animate-this">
					...
					<div class="service-content">
						<h3 class="h05">Full Stack Technologies</h3>
						<p></p>
					</div>
				</div>
				<!-- end bgrid -->
		...
		<div class="intro-wrap">
			...
			<div class="row narrow section-intro with-bottom-sep animate-this">
				<div class="col-twelve">
					...
					<p class="lead">Our service includes a comprehensive consult to help identify gaps and opportunities, a comprehensive report that includes
						a project plan with timelines and milestones, a cost analysis, and a schedule. We also offer a suite of quality products
						that will help you get there quickly and smoothly.</p>
				</div>
			</div>
					...
					<li>
						...
						<div class="testimonial-author">
							...
							<div class="author-info">
								Text from client
								<span class="position">CEO, Client.</span>
							</div>
						</div>
					</li>
					<!-- end slide -->
		...
		<div class="row animate-this">
			<div class="col-twelve">
				...
				<div class="client-lists owl-carousel">
					<div>
						<img src="images/clients/rubyonrails.png" alt="">
					</div>
					<div>
						<img src="images/clients/ios.png" alt="">
					</div>
					<div>
						<img src="images/clients/android.png" alt="">
					</div>
					<div>
						<img src="images/clients/tech.png" alt="">
					</div>
				</div>
			</div>
			<!-- end col-twelve -->
   ...
   ================================================== -->
	<section id="contact">
		...
		<div class="row narrow section-intro with-bottom-sep animate-this">
			<div class="col-twelve">
				<h3>Why Us?</h3>
				<p class="lead">Business mentors are key—that’s why when it comes to client selection, we’re choosy. We want to give each of you the
					time and guidance they deserve. We didn’t get there alone. And neither will you. Call us today.</p>
	...
	<footer>
		...
		<div class="footer-bottom">
			...
			<div class="row">
				...
				<div class="col-twelve">
					<div class="copyright">
						<span>Copyright © 2017 IT SWARM - All Rights Reserved.</span>
					</div>
				</div>
